...
class Controller:
    ...
    def _register_default_actions(self):
        ...
        @self.registry.action(
            "Go back", param_model=NoParamsAction, requires_browser=True
        )
        ...
        async def get_dropdown_options(
            params: GetDropdownOptionsAction, browser: BrowserContext
        ) -> ActionResult:
        ...
        async def select_dropdown_option(
            ...
            logger.debug(
                f"Attempting to select '{params.text}' using xpath: {dom_element.xpath}"
            )
